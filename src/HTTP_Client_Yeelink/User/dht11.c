...
void LED_GPIO_Configuration(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2; ///< Connecting GPIO_Pin_8(LED(R))
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT; ///< Set to GPIO Mode to Output Port
//		GPIO_InitStructure.GPIO_Pad = GPIO_SUMMIT;
    GPIO_Init(GPIOA, &GPIO_InitStructure);
    PAD_AFConfig(PAD_PA, GPIO_Pin_2, PAD_AF1); ///< PAD Config - LED used 2nd Function	
